...
-- DropForeignKey
ALTER TABLE "HairMetric" DROP CONSTRAINT "HairMetric_patientId_fkey";

-- DropForeignKey
ALTER TABLE "Photo" DROP CONSTRAINT "Photo_patientId_fkey";

-- DropForeignKey
ALTER TABLE "TransplantProcedure" DROP CONSTRAINT "TransplantProcedure_patientId_fkey";
...
-- AddForeignKey
ALTER TABLE "HairMetric" ADD CONSTRAINT "HairMetric_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES "Patient"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "TransplantProcedure" ADD CONSTRAINT "TransplantProcedure_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES "Patient"("id") ON DELETE CASCADE ON UPDATE CASCADE;
